...
import {SET_FILTER_DETAILS,SET_FILTER_HOMETYPE,SET_FILTER_AMNETIES,SET_FILTER_LIFESTYLE,SET_COUNTER} from "../actions/types";

// import {SET_HOME_IMG} from "../actions/types";
//?check later if you can use one reducer for all? 
...
export const homeTypeFilterReducer = (state = initialhomeTypeState, action)=> {
  ...
  export const lifeStyleFilterReducer = (state = initialLifeStyleState, action)=> {
    switch (action.type) {
